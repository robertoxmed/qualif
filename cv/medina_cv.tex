...
%L'objectif principal de ce projet de recherche consiste à proposer une méthode d'ordonnancement qui 
%prend 
%en compte un modèle probabiliste sur les temps d'exécution des programmes pour minimiser la 
%consommation énergétique des systèmes temps-réels. En ayant connaissance sur la distribution des 
%temps 
